...
Public Class RdfMapping
    ...
    Public Sub New(ByVal rdf_table As String, ByRef dbSchema As dbSchema)
    ...
    End Sub
    Public Sub New(ByVal rdf_table As String, ByRef db_schemas As List(Of dbSchema))
    ...
    Public Sub insertBatch(ByRef rdfs As List(Of Rdf), ByRef db As String, ByRef tableName As String)
        Dim sql As String = ""
        Dim cmd As OracleCommand
    ...
    Public Sub Mapping_AllSchemas()
        ...
        For Each schema As dbSchema In Me.db_schemas
            ...
            For Each tableName As String In schema.GetTables().Keys
                insertBatch(Me.MappingSingleTable(schema, tableName), schema.DATABASE_NAME, tableName)
            Next
    ...
    Public Function MappingSingleTable(ByRef schema As dbSchema, ByVal table As String) As List(Of Rdf)
        ...
        Dim pgsqlConnection As PgSqlConnection = schema.CONNECTION
        pgsqlConnection.Open()
        Dim cmd As New PgSqlCommand(selectStatement, pgsqlConnection)
