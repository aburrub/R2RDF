...
Imports System.Xml
Public Class Form1
    Private conversionPath As String = "../../conversion.txt"
    ...
    Private Sub Mapping_Button_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Mapping_Button.Click
        ...
        Next
        Dim mappingObj As New RdfMapping("rdfdata", schemas, conversionPath)
        mappingObj.Mapping_AllSchemas(Me.outputTextBox)
